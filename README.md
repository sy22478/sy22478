...
- [View repository](https://github.com/sy22478/ReneWind)
...
- [View repository](https://github.com/sy22478/Restaurant-Turnover-Prediction)
...
- [View repository](https://github.com/sy22478/EasyVisa)

**Stock Market News Sentiment Analysis and Summarization**
- Advanced NLP and machine learning project to analyze news sentiment and its impact on stock prices
- Multi-model ensemble with Decision Trees, Random Forest, Gradient Boosting, XGBoost
- Word2Vec, GloVe, and Sentence-BERT transformers for feature engineering
...
- [View repository](https://github.com/sy22478/resume-tailoring-ai-agent)
